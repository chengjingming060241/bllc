...
public interface SysMessageToUserDao extends BaseMapper<SysMessageToUser> {
    ...
    List<Integer> listSysMessageId(@Param("userId") Integer userId,@Param("userType")Integer userType);

    List<Integer> listUnReadSysMessageIds(@Param("userId") Integer userId,@Param("userType")Integer userType);

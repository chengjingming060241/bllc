...
public interface ProductServiceModeService extends IService<ProductServiceMode> {
    ...
    ProductServiceMode selectById(Integer id);
     ...
     * @return
     */
    Page<ProductServicecModeListDto> getProductServiceModeListDtoPage(Pageable<ProductServiceListQuerytDto> pageable);


    /**
     * 查询收费模式详情
     * ***/
    ProductServicecModeListDto getProductServiceModeDetail(Integer serviceModeId);

...
public class MailApi {
    ...
    private static final String MAIL_HOST_VALUE ="smtp.126.com"; //发送邮件的服务器地址
    ...
    //邮件编辑信息(仅需写上自己的)
    private static final String MAIL_FROM ="chengjingming@126.com";//邮件发送人
    private static final String MAIL_FROM_PASSWORD ="cjm060241";//邮件发送人授权码
    private static final String MAIL_SUBJECT_REGISTER ="【找回密码】";//邮件主题(注册链接)
    private static final String MAIL_SUBJECT_VERIFY_CODE ="【邮箱验证码】";//邮件主题(邮箱验证码)
    private static final String MAIL_ORGANIZATION ="布朗(上海)环境技术有限公司";//邮件组织
    private static final String MAIL_WEBSITE ="https://www.xxxx.com/";//组织主页
    private static final String MAIL_ORGANIZATION_LOGO ="https://www.xxxx.com/xxxx/xxx.jpg";//网站logo
    private static final String MAIL_ORGANIZATION_QRCODE ="https://www.xxxx.com/xxxx/xxx.jpg";//网站二维码图片


    public static void main(String[] args) throws Exception{
        //验证码
        sendEmail("909286181@qq.com");
        //链接
//        sendEmail(MAIL_FROM,
//                "909286181@qq.com",
...
//        props.setProperty(MAIL_DEBUG, "true");//邮件发送的调试模式，参数是规范规定的
        ...
        message.setSubject(   MAIL_SUBJECT_VERIFY_CODE   );
        //设置正文
        String verifyCode = String
                .valueOf(new Random().nextInt(899999) + 100000);//生成短信验证码
        message.setContent(   prettyLayout(MAIL_ORGANIZATION,MAIL_WEBSITE,
                MAIL_ORGANIZATION_LOGO,
                prettyQrCodeLayout("3分钟",verifyCode),
                MAIL_ORGANIZATION_QRCODE),SEND_ENCODING_LAYOUT);

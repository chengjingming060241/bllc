...
public interface StatDeviceLocationService extends IService<StatDeviceLocation> {
    ...
    List<StatLocationVo> getDistribution(List<Integer> productIds, SysUser currentUser, List<Integer> sysUserIds);

    List<StatLocationVo> getRank(List<Integer> productIds, SysUser currentUser, List<Integer> ids);
}

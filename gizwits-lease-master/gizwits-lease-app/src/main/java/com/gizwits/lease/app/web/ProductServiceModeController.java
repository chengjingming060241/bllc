...
public class ProductServiceModeController extends BaseController {
    ...
    public @ResponseBody
    ResponseObject<AppProductServiceDetailVo> get(@RequestBody @Valid RequestObject<AppServiceModeDetailDto> requestObject) {
    ...
    public ResponseObject<ProductServicecModeListDto> detail(@RequestBody @Valid RequestObject<Integer> requestObject) {
        ...
        return ResponseObject.ok(productServiceModeService.getProductServiceModeDetail(service_mode_id));
    }

package com.gizwits.lease.utils.http;
...
public class HttpClientUtil {
	...
	public static String httpRequest(String url, Map<String, String> headers,
		...
		AbstractHttpMessage httpMessage = getHttpMessage(url, headers, bodyJsonStr, methodType);
		if(httpMessage == null)
			return null;
	...
	public static boolean requestResult(String url, Map<String, String> headers,
									 String bodyJsonStr,MethodType methodType){
		AbstractHttpMessage httpMessage = getHttpMessage(url, headers, bodyJsonStr, methodType);
		if(httpMessage == null)
			return false;

		return sendRequest((HttpRequestBase)httpMessage);
	}

	private static AbstractHttpMessage getHttpMessage(String url, Map<String, String> headers,
							String bodyJsonStr,MethodType methodType){
...
//				result = EntityUtils.toString(entity);
	...
	private static boolean sendRequest(HttpRequestBase request){
		CloseableHttpResponse response = null;
		try{
			response = httpClient.execute(request);

...
public interface StatDeviceLocationDao extends BaseMapper<StatDeviceLocation> {
    ...
    List<StatDeviceLocation> getDistributionByIds(@Param("productIds") List<Integer> productIds,@Param("ids") List<Integer> ids,@Param("date") Date yesterday);

    List<StatDeviceLocation> getRankByIds(@Param("productIds") List<Integer> productIds,@Param("ids") List<Integer> ids,@Param("date") Date yesterday);

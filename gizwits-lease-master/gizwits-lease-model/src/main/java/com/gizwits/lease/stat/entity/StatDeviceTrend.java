...
public class StatDeviceTrend extends Model<StatDeviceTrend> {
     ...
     * 今日新激活设备数
     */
    @TableField("new_activated_count")
    private Integer newActivatedCount;
    ...
    public Integer getNewActivatedCount() {
        return newActivatedCount;
    }

    public void setNewActivatedCount(Integer newActivatedCount) {
        this.newActivatedCount = newActivatedCount;
    }

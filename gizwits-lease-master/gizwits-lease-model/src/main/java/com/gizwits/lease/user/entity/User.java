...
public class User extends Model<User> {
	 ...
	 * 腾讯id
	 */
	@TableField("tencent_unionid")
	private String tencentUnionid;
	/**
	 * 腾讯昵称
	 */
	@TableField("tencent_nickname")
	...
	public String getTencentUnionid() {
		return tencentUnionid;
	}

	public void setTencentUnionid(String tencentUnionid) {

...
public class ManufacturerController extends BaseController {
    ...
    public @ResponseBody ResponseObject<DeleteDto> delete(@RequestBody @Valid RequestObject<List<Integer>> requestObject){
        return success(manufacturerService.delete(requestObject.getData()));
    }
}

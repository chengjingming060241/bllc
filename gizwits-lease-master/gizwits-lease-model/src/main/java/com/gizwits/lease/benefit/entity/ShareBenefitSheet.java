...
public class ShareBenefitSheet extends Model<ShareBenefitSheet> {
	...
	@TableField("wx_total_money")
	private Double wxTotalMoney;

	@TableField("card_total_money")
	private Double cardTotalMoney;

	@TableField("alipay_total_money")
	private Double alipayTotalMoney;

	@TableField("other_total_money")
	...
	@ApiModelProperty("分润批次id")
	@TableField("share_profit_batch_id")
	private Integer shareProfitBatchId;
	...
	public Double getCardTotalMoney() {
		return cardTotalMoney;
	}

	public void setCardTotalMoney(Double cardTotalMoney) {
		this.cardTotalMoney = cardTotalMoney;
	}

	public Double getAlipayTotalMoney() {
		return alipayTotalMoney;
	}
	...
	public Integer getShareProfitBatchId() { return shareProfitBatchId; }

	public void setShareProfitBatchId(Integer shareProfitBatchId) { this.shareProfitBatchId = shareProfitBatchId; }

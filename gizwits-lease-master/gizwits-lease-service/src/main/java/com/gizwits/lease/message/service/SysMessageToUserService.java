...
public interface SysMessageToUserService extends IService<SysMessageToUser> {
     ...
     * @return
     */
    List<Integer> listSysMessageId(Integer userId,Integer userType);

    List<Integer> listUnReadSysMessageIds(Integer userId, Integer userType);

    SysMessageToUser selectByMessageId(Integer messageId);
}

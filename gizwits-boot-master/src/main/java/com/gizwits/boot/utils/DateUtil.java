...
public class DateUtil {
    ...
    /**
     * 获取日历
     * @param addMonth 增加月数,正数表示增加,负数表示减少
     * @return
     */
    public static Calendar getCalender(Integer addMonth){
        Calendar calendar = Calendar.getInstance();
    ...
    //获取月份的第一天,如2016-03-01 00:00:00
    public static Date getFirstDay(Calendar calendar){
        if(ParamUtil.isNullOrEmptyOrZero(calendar)){
            return  null ;
        }
        //将小时至0

...
public class StatDeviceOrderWidget extends Model<StatDeviceOrderWidget> {
     ...
     * 已激活设备数
     */
    @TableField("activated_device_count")
    private Integer activatedDeviceCount;

    /**
     * 今日新激活设备数
     */
    @TableField("activated_device_count_today")
    private Integer activatedDeviceCountToday;
    ...
    public Integer getActivatedDeviceCount() {
        return activatedDeviceCount;
    }

    public void setActivatedDeviceCount(Integer activatedDeviceCount) {
        this.activatedDeviceCount = activatedDeviceCount;
    }

    public Integer getActivatedDeviceCountToday() {
        return activatedDeviceCountToday;
    }

    public void setActivatedDeviceCountToday(Integer activatedDeviceCountToday) {
        this.activatedDeviceCountToday = activatedDeviceCountToday;
    }

...
public class DeviceOfflineHandler implements PushEventHandler {
    ...
    public void processPushEventMessage(JSONObject json) {
        ...
        log.info("设备下线===>pk:{} did:{} mac:{}", productKey, did, mac);
        ...
        deviceService.updateDeviceOnOffLineStatus(mac, productKey, did, false);
        redisService.cacheDeviceOnlineStatus(productKey, mac, false);
        // 清除设备缓存日志
        redisService.deleteDeviceCurrentStatus(productKey,mac);
